...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['5 kinematic chains', 'CCD solver only', '10 IK jobs/hr', 'Community support'] },
  { name: 'Pro', price: '$49/mo', features: ['100 kinematic chains', 'All 5 solvers', '1,000 IK jobs/hr', 'Batch solving', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited chains', 'Custom solvers', 'Real-time API', 'SLA guarantee', 'Dedicated support'] },
];
